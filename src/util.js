/* eslint no-bitwise: 0, no-loss-of-precision: 0, no-constant-condition: 0, no-empty: 0 */

const LZMA = (function() {

  /**
   * LZMA - https://lzma-js.github.io/LZMA-JS/src/lzma_worker.js
   *
   * Copyright (c) 2015 Nathan Rugg <nmrugg@gmail.com> | MIT
   */
...
const b64 = (function() {
  ...
  /**
   * base64-js - https://github.com/beatgammit/base64-js/blob/master/index.js
   *
   * Copyright (c) 2014 Jameson Little | MIT
   */
